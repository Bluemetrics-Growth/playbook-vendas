...
export const ifThenRules: IfThenRule[] = [
  {
    ...
    action: "Entra na lista de LinkedIn Ads, nos dois tiers, em todas as etapas (lista ativa, não workflow).",
  },
  {
    id: "r-t2-nutricao",
    tier: "Tier 2",
  ...
  },
  {
    ...
    action: "Ativação do comitê e air cover.",
  },
  {
    id: "r-t1-inatividade",
    tier: "Tier 1",
...
export const orchestrationSequence: OrchestrationStage[] = [
  { step: 1, name: "Paid aquece", role: "Ads always-on preparam o comitê e mantêm a marca presente." },
...
export const slaNote =
  "SLA: sinal quente exige ação em até 24h. Registrar toda atividade. No Tier 1 o registro é o que segura o score.";
