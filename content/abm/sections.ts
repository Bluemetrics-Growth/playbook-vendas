...
export const abmSections: AbmSection[] = [
  ...
  { slug: "tier3", href: "/abm/tier3", title: "Tier 3 · Prospecção US", short: "Contas frias dos EUA, new logo e winback", icon: "Globe", group: "Operação", cover: "/brand/bg-8.jpg", duration: "9 min" },
