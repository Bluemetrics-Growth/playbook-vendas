...
export const abmSections: AbmSection[] = [
  ...
  { slug: "simulador", href: "/abm/simulador", title: "Simulador de Score", short: "Como ler score, prioridade e próxima ação", icon: "Calculator", group: "Modelo", cover: "/brand/bg-liquid-deep.png", duration: "8 min", videoUrl: "/videos/abm/simulador.mp4" },
