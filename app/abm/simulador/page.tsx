...
export const metadata = { title: "Calculadora de Score" };

export default function SimuladorPage() {
  return (
    <SectionShell slug="simulador">
      <PageHeader
        eyebrow="ABM · Calculadora"
        title="Calculadora de Score"
        intro="Marque os sinais e veja o score, a banda e o workflow que dispara ao vivo. Cada categoria respeita o teto. Use para treinar a leitura que você viu na tela anterior."
      />
      ...
      <div className="mt-8 flex items-start gap-3 rounded-m border border-border bg-bg-soft px-4 py-3 text-[13px] text-fg-muted">
        ...
        <span>
          ...
          nutrição 60-79). A regra é a mesma: o score move entre bandas, nunca troca o tier.
        </span>
      </div>
    </SectionShell>
  );
